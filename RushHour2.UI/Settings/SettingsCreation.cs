    ...
    public static class SettingsCreation
    {
        public static void Create(UIHelperBase helper)
        {
            ...
            if (FeatureToggles.LightingModificationsActive)
            {
                ...
                {
                    lightingGroup.AddCheckbox(LocalisationHolder.Translate(LocalisationHolder.CurrentLocalisation.Settings_Lighting_OverrideLights), UserModSettings.Settings.Buildings_OverrideLights_1, new OnCheckChanged(value => UserModSettings.Settings.Buildings_OverrideLights_1 = value));
                    lightingGroup.AddCheckbox(LocalisationHolder.Translate(LocalisationHolder.CurrentLocalisation.Settings_Lighting_LightsEducation), UserModSettings.Settings.Buildings_OverrideSchoolLights_1, new OnCheckChanged(value => UserModSettings.Settings.Buildings_OverrideSchoolLights_1 = value));
                    lightingGroup.AddCheckbox(LocalisationHolder.Translate(LocalisationHolder.CurrentLocalisation.Settings_Lighting_LightsCommercial), UserModSettings.Settings.Buildings_OverrideCommercialLights_1, new OnCheckChanged(value => UserModSettings.Settings.Buildings_OverrideCommercialLights_1 = value));
                    lightingGroup.AddCheckbox(LocalisationHolder.Translate(LocalisationHolder.CurrentLocalisation.Settings_Lighting_LightsOffices), UserModSettings.Settings.Buildings_OverrideOfficeLights_1, new OnCheckChanged(value => UserModSettings.Settings.Buildings_OverrideOfficeLights_1 = value));
                    lightingGroup.AddCheckbox(LocalisationHolder.Translate(LocalisationHolder.CurrentLocalisation.Settings_Lighting_LightsIndustrial), UserModSettings.Settings.Buildings_OverrideIndustrialLights_1, new OnCheckChanged(value => UserModSettings.Settings.Buildings_OverrideIndustrialLights_1 = value));
                    lightingGroup.AddCheckbox(LocalisationHolder.Translate(LocalisationHolder.CurrentLocalisation.Settings_Lighting_LightsResidential), UserModSettings.Settings.Buildings_OverrideResidentialLights_1, new OnCheckChanged(value => UserModSettings.Settings.Buildings_OverrideResidentialLights_1 = value));
                }
            }
